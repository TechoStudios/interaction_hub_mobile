...
class TeacherGroupChat extends StatefulWidget {
  final String groupChatRoomId;
  final String groupName;

  TeacherGroupChat(this.groupChatRoomId, this.groupName);

  @override
  _TeacherGroupChatState createState() => _TeacherGroupChatState();
}

class _TeacherGroupChatState extends State<TeacherGroupChat> {
            ...
            ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return MessageTile(
                    ...
                    sendByMe: Constants.loginTeacher[0].name ==
  ...
  addMessage() {
    if (messageEditingController.text.isNotEmpty) {
      Map<String, dynamic> chatMessageMap = {
        "sendBy": Constants.loginTeacher[0].name,
